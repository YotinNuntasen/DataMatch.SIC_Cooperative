...
export const apiConfig = {
  sharepoint: {
    baseURL: process.env.VUE_APP_API_BASE_URL || 'nbo-matching-fmgddgbhfkgjddhj.southeastasia-01.azurewebsites.net/api',
  ...
  azure: {
    baseURL: process.env.VUE_APP_AZURE_API_BASE_URL || 'https://nbo-matching-fmgddgbhfkgjddhj.southeastasia-01.azurewebsites.net/api',
